# Beets Music Management Configs and file Examples

hello everyone, i struggled with beets and figured i'd share a bit of information here for other to find and maybe explain some concepts behind them and how to use.
